...
namespace Lotus {
	...
	*/
	/** When thrown, provides information about an error that has occurred inside the engine.
        @remarks
            Lotus never uses return values to indicate errors. Instead, if an
            ...
            Lotus should always ensure that the exceptions are caught, so all
            Lotus engine functions should occur within a
            try{} catch(Lotus::Exception& e) {} block.
        @par
        ...
        */
        ...
        /** Returns a string with the full description of this error.
            @remarks
                ...
                the place in which Lotus found the problem, and a text
	...
	*/
	...
	@remarks
		...
		a distinct type so that methods can be overloaded. This allows Lotus_EXCEPT
...
//  这个地方实现得相当干净和漂亮	
#ifndef LOTUS_EXCEPT
#define LOTUS_EXCEPT(num, desc, src) throw Lotus::ExceptionFactory::create( \
	Lotus::ExceptionCodeType<num>(), desc, src, __FILE__, __LINE__ );
#endif
	/** @} */
	/** @} */
